...
const CLEAN_FRESH_PRODUCTS = [
  { id: 901, n: "सरिया 8 MM (Tata Tiscon)", b: "Tata Tiscon", p: 62, u: "प्रति किलो (per kg)", cat: "tmt", stock: 500, rating: 4.8, visible: true, img: "", moq: 10 },
  { id: 902, n: "सरिया 10 MM (JSW Neosteel)", b: "JSW Neosteel", p: 61, u: "प्रति किलो (per kg)", cat: "tmt", stock: 500, rating: 4.7, visible: true, img: "", moq: 10 },
  { id: 903, n: "सरिया 12 MM (SAIL)", b: "SAIL", p: 60, u: "प्रति किलो (per kg)", cat: "tmt", stock: 500, rating: 4.6, visible: true, img: "", moq: 10 },
  { id: 904, n: "सरिया 16 MM (Kamdhenu)", b: "Kamdhenu", p: 59, u: "प्रति किलो (per kg)", cat: "tmt", stock: 500, rating: 4.5, visible: true, img: "", moq: 10 },
  { id: 905, n: "सीमेंट UltraTech OPC 53 Grade", b: "UltraTech", p: 410, u: "प्रति बैग (50kg bag)", cat: "cement", stock: 300, rating: 4.9, visible: true, img: "", moq: 10 },
  { id: 906, n: "सीमेंट Ambuja PPC", b: "Ambuja", p: 380, u: "प्रति बैग (50kg bag)", cat: "cement", stock: 200, rating: 4.8, visible: true, img: "", moq: 10 },
  { id: 907, n: "रेत River Sand (बालू)", b: "Local River", p: 1800, u: "प्रति टन (per ton)", cat: "sand", stock: 50, rating: 4.5, visible: true, img: "", moq: 1 },
  { id: 908, n: "गिट्टी 20 MM Aggregate", b: "Local Quarry", p: 1200, u: "प्रति टन (per ton)", cat: "sand", stock: 80, rating: 4.4, visible: true, img: "", moq: 1 },
  { id: 909, n: "लाल ईंट Red Bricks Class A", b: "Kiln Standard", p: 9, u: "प्रति पीस (per piece)", cat: "brick", stock: 5000, rating: 4.6, visible: true, img: "", moq: 200 }
];
...
export default function App() {
  ...
  const [products, setProducts] = useState(ls.get("as_prod_master_v12", CLEAN_FRESH_PRODUCTS));
  const [workers, setWorkers] = useState(ls.get("as_wrk_master_v12", DEFAULT_WORKERS));
  ...
  useEffect(() => {
    try {
      const unsub = onSnapshot(doc(db, "app_data", "main_store_v12"), (snap) => {
        if (snap.exists()) {
  ...
  useEffect(() => ls.set("as_prod_master_v12", products), [products]);
  useEffect(() => ls.set("as_wrk_master_v12", workers), [workers]);
...
function AdminScreen({ 
  ...
  const syncToFirestore = async (newProds, newWrks, newBank) => {
    try { await setDoc(doc(db, "app_data", "main_store_v12"), { products: newProds || products, workers: newWrks || workers, bankInfo: newBank || bankInfo }, { merge: true }); } catch (e) {}
  };
